...
public class HttpClient {
	 ...
	 */
	public HttpClient(String url, int connectionTimeout, int readTimeOut, SDKConfig sdkConfig) throws Exception {
		try {
	...
	private String response(final HttpURLConnection connection, String encoding)
		...
		try {
			...
			LogKit.info("HTTP Return Status-Code:[" + connection.getResponseCode() + "]");
			return sb.toString();
		} catch (Exception e) {
			throw e;
		} finally {
	...
	private String getRequestParamString(Map<String, String> requestParam, String coder) {
		...
		LogKit.info("Request Message:[" + reqstr + "]");
		return reqstr;
	}
